...
const Order: React.FC<OrderProps> = ({ order }) => {
  ...
  return (
    <div>
      <tr key={order.id}>
        <td className="w-full">stt: {order.id}</td>
        <td className="w-full">Sản phẩm: {order.product.name}</td>
        <td className="w-full">giá: {order.product.price}</td>
        <td className="w-full">khách hàng: {order.name}</td>
